...
| 3388398 loop-evalLh | L-history 缺的 8 个全矩阵（s1：245k / 240k / best；s7：240k / best；s123：245k / 240k / best），`MODE=eval` | 6 h | 完成 09-18 15:29，6 / 8 成功；s1 best 与 s123 245k 因 8 个评估共用一卡 CUDA OOM，单独重提（loop-evalLh2） |
